...
export const MSH_AGENT_REGISTRY: readonly MshAgentMetadataCard[] = [
  ...
  activeReadOnlySpecialist('genesis', 'Genesis', 'Growth & Acquisition', ['growth_strategy', 'acquisition']),
  activeReadOnlySpecialist('newton', 'Newton', 'Business Strategy & Finance', ['business_strategy', 'finance']),
  activeReadOnlySpecialist('harper', 'Harper', 'People & Hiring', ['people_operations', 'hiring']),
