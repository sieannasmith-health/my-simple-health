...
-- Relationships are visible only to the two involved accounts. Pending invitees
-- resolve their own invitations by email through the RPC below rather than broad table reads.
