...
test('shared application shell mounts the existing Hello runtime instead of duplicating it', () => {
  assert.match(shellSource, /loadScript\('js\/msh-hello-workspace\.js'\)/);
