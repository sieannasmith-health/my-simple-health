...
(function () {
  ...
  function wellnessWheelVisual() {
    ...
    if (!scores) return `<section class="msh-signature-wheel msh-wheel-empty"><div class="msh-wheel-orbit" aria-hidden="true"><i></i><i></i><i></i></div><div><p class="msh-eyebrow">Signature Landscape</p><h2>Your Wellness Wheel</h2><p>Eight dimensions become one calm, explorable picture of where you are now.</p><a class="msh-button" href="health-landscape.html">Map My Wellness Wheel →</a></div></section>`;
