  ...
  const intents = Object.freeze([
    {
      ...
      optional: false,
      orientation: 'Hello can help explain health information, translate unfamiliar language, and think through what would be useful to understand next. It will not diagnose you or pretend to know facts you have not shared.',
      primary: { label: 'Take my question to Hello', href: 'hello.html?from=first-door' }
    },
    {
      id: 'not_working',
      ...
      optional: true,
      orientation: 'You do not need to decide whether this is a problem, goal, or something to fix. Hello can help you understand what is happening before you choose what—if anything—you want to do.',
      primary: { label: 'Talk it through with Hello', href: 'hello.html?from=first-door' },
      secondary: { label: 'Look at my broader picture', href: 'my-landscape.html' }
    },
    {
    ...
    },
    {
      ...
      optional: true,
      orientation: 'Hello can help you think through what kind of professional may be useful or organize questions for a visit. This prototype does not yet provide a verified provider or services directory.',
      primary: { label: 'Think through support with Hello', href: 'hello.html?from=first-door' }
    },
    {
      id: 'clearer_picture',
