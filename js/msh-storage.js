...
(function (root) {
  ...
  function createInitialState() {
    return {
      ...
      calendar: {
        ...
        predictions: [],
        settings: {
          layers: { cycle:true, life:true, appointments:true, workSchool:true, practices:true, projects:true, routines:true },
  ...
  root.MSHStorage = {
    STORAGE_KEY, SCHEMA_VERSION, HELLO_HISTORY_LIMIT, PROVENANCE, createInitialState, normalizeState, getState,
